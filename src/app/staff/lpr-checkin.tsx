          ...
          <View style={styles.lprHeader}>
            ...
            <View style={styles.lprStatus}>
              <View
                style={[
                  styles.statusDot,
                  isScanning ? styles.statusDotActive : styles.statusDotSuccess,
                ]}
              />
              <Text style={styles.statusText}>
                {isScanning ? "Đang quét..." : "Đã nhận diện"}
              </Text>
            </View>
          </View>
            ...
            {detectedPlate ? (
                  ...
                  <View style={styles.confidenceBar}>
                    <View
                      style={[
                        ...
                        { width: `${detectedPlate.confidence * 100}%` },
                      ]}
                    />
                  </View>
                  <Text style={styles.confidenceText}>
                    Độ chính xác: {Math.round(detectedPlate.confidence * 100)}%
                  </Text>
                </View>
              </Animated.View>
            ) : (
              <View style={styles.scanPrompt}>
                ...
                <Text style={styles.scanPromptSubtext}>
                  Hệ thống sẽ tự động nhận diện trong 10 giây
                </Text>
              </View>
            )}
          </View>
              ...
              <View style={styles.vehicleInfoHeader}>
                <View style={styles.customerAvatar}>
                  <Text style={styles.avatarText}>
                    {detectedPlate.userName?.charAt(0) || "?"}
                  </Text>
                </View>
                <View style={styles.vehicleInfoContent}>
                  <Text style={styles.customerName}>
                    {detectedPlate.userName}
                  </Text>
                  <View
                    style={[
                      styles.membershipBadge,
                      getMembershipBadgeStyle(detectedPlate.membershipTier!),
                    ]}
                  >
                    <Text
                      style={[
                        ...
                        {
                          color: getMembershipBadgeStyle(
                            detectedPlate.membershipTier!,
                          ).textColor,
                        },
                      ]}
                    >
          ...
          {detectedPlate && detectedPlate.status === "not_found" && (
            <View style={styles.notFoundCard}>
              ...
              <Text style={styles.notFoundText}>
                Xe không có trong hệ thống. Vui lòng kiểm tra lại hoặc thêm xe
                mới.
              </Text>
          ...
          <View style={styles.queueHeader}>
            ...
            <View style={styles.queueStats}>
              ...
              <View style={styles.queueStat}>
                ...
                >
                  {queueItems.filter((i) => i.isPriority).length}
                </Text>
          ...
          >
            ...
            {queueItems
              ...
              .map((item, index) => (
                <View
                  key={item.id}
                  style={[styles.queueItem, styles.priorityQueueItem]}
                >
                  ...
                  <View style={styles.queueLane}>
                    <Text style={styles.queueLaneText}>Làn VIP</Text>
                  </View>
                </View>
              ))}
            {queueItems.filter((item) => item.isPriority).length === 0 && (
              <View style={styles.emptyQueue}>
                <Text style={styles.emptyQueueText}>
                  Không có xe trong làn ưu tiên
                </Text>
              </View>
            )}
            ...
            {queueItems
              ...
              .map((item, index) => (
                <View key={item.id} style={styles.queueItem}>
                  ...
                  <View style={[styles.queueLane, styles.regularLaneBadge]}>
                    <Text
                      style={[
                        styles.queueLaneText,
                        { color: LuxeColors.secondary },
                      ]}
                    >
                      Làn {index + 1}
                    </Text>
...
const styles = StyleSheet.create({
  ...
  queuePanel: {
    ...
    borderLeftWidth: 1,
    borderLeftColor: LuxeColors.outlineVariant + "30",
    padding: LuxeSpacing.md,
  },
  queueHeader: {
    flexDirection: "row",
